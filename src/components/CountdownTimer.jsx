...
const EventCountdown = () => {
  const eventDate = "2025-02-15T00:00:00"; // Example event date
  
  return (
    <div className="p-8 hidden sm:block">
      <h2 className="text-md font-medium text-center text-white mb-6 mt-10">Step into the allure of India! Pravah 2025 begins in...</h2>
